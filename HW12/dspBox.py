...
def volume(frameCut):  # 改名字 signal -> frameCut
    # enframe = frameMat(signal, frameSize, overlap)  # 註解掉這行 因為沒有用到
    rows, cols = frameCut.shape  # 找不到 frameCut, 應該是要帶入 frameMat() 的結果 所以我改了一下
